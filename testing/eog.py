...
Moving my eyes vertically shifts the corneal-retinal dipole which would in theory produce a much more crisp 
and un-missable (maybe 150-300 microvolt) pulse in the TIME domain, that is detectable with the single FP1 
electrode.

This is a script I am making to test if vertical eye movements are actually high-signal-to-noise physiological 
gestures capturable with the Neurosky Mindwave Mobile 2.
"""
...
# Set an initial threshold estimate (Adjustable based on your Plot 3 height)
THRESHOLD = 300.0
